...
export class ConfigurationService {
  ...
  public baseUrl = environment.baseUrl || DBkeys.URLpath;
  public tokenUrl = environment.tokenUrl || environment.baseUrl || DBkeys.URLpath;
  public loginUrl = environment.loginUrl;
  public fallbackBaseUrl = 'https://smartapp.girishgodage.in';
  // ***End of defaults***
  ...
  public import(jsonValue: string) {
      ...
      if (jsonValue) {
          const importValue: UserConfiguration = this.JsonTryParse(jsonValue);
